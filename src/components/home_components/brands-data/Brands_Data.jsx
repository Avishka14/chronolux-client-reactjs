...
export const brands = [
  {
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Rolex Logo Wallpaper.jpg"
  },
  {
    id: "1",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Patek Philippe logo wallpaper.jpg",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Hublot Logo Wallpaper.jpg",
  },
  {
    id: "4",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Richard Mille Logo Wallpaper.jpg",
  },
  {
    id: "5",
    brandName: "Omega",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Omega Logo Wallpaper.jpg",
  },
  {
    id: "6",
    brandName: "Breitling",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Breitling Logo Wallpaper.jpg",
  },
  {
    id: "7",
    brandName: "Panerai",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Panerai Logo Wallpaper.jpg",
   },
  {
    id: "8",
    ...
    coverImage: "/assets/brand-img/brand-cover-img/Jaeger LeCoultre Logo Wallpaper.jpg",
  },
  {
    id: "9",
    brandName: "Breguet",
    title: "Inventor of Modern Watchmaking",
    description: "Founded in 1775 by Abraham-Louis Breguet, this historic brand is credited with numerous horological innovations, including the tourbillon and the Breguet hands. Known for its classical styling, guilloché dials, and technical mastery, Breguet represents elegance and intellect in the world of fine watchmaking, with deep ties to European nobility and science.",
   coverImage: "/assets/brand-img/brand-cover-img/Breguet Logo Wallpaper.jpg",  
  },
];
